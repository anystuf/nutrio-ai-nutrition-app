...
export function UpgradePlanContent({ user, onPayment }) {
...
export function PaymentMethodContent({ user }) {
  return (
    <View>
      <UserLine user={user} />
...
export function ContactUsContent({ user, onDone }) {
...
export function PersonalDataContent({ profile, onEdit }) {
  const rows = [
...
export function BodyMetricsContent({ profile }) {
...
export function CalorieCounterContent({ profile }) {
  return (
    <View style={styles.card}>

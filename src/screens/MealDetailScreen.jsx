...
export function MealDetailScreen({ user, mealType, onNavigate }) {
  const [items, setItems] = useState([]);
  const [editingItem, setEditingItem] = useState(null);
  const [form, setForm] = useState({ portion: "1" });
...
function NutritionPreview({ item, portion }) {

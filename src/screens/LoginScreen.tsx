...
export function LoginScreen({ onSignup, onForgotPassword, onDone }: Props) {
...
function SocialLoginRow({ disabled, onGoogle }: { disabled: boolean; onGoogle: () => void }) {
  return (
...
function SocialButton(props: { disabled: boolean; icon: keyof typeof FontAwesome.glyphMap; color: string; onPress: () => void }) {
  return (

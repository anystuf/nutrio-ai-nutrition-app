...
export function DetailedMealConsumedScreen({ user, onNavigate }: Props) {
...
function MealBlock({ title, amount, color, items }: { title: string; amount: number; color: string; items: Array<{ name: string; amount: number }> }) {
  return (

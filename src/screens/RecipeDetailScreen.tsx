...
export function RecipeDetailScreen({ recipe, onNavigate }: Props) {
  return (
    <Screen scroll>
...
function InfoCard({ icon, color, label }: { icon: keyof typeof Ionicons.glyphMap; color: string; label: string }) {
  return (

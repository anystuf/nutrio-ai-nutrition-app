...
export function calculateAngle(first: PosePoint, middle: PosePoint, last: PosePoint) {
...
export function countSquat(pose: SquatPose) {
...
export function estimateCalories({ exercise, reps, userWeightKg }: { exercise: string; reps: number; userWeightKg: number }) {

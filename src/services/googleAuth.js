...
import { getAdditionalUserInfo, GoogleAuthProvider, signInWithCredential, signInWithPopup } from "firebase/auth";
...
async function ensureGoogleUserDocument(user, forceCreate) {
